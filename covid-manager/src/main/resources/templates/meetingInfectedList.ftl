<#include "inc/header.ftl">
        <div class="right">
            <div class="location">
                ...
                <span>MEETING INFECTED MANAGER</span>
            </div>
            <div class="search">
           		<form method="get" action="${request.contextPath}/meetingInfected/query">
            ...
            <table class="providerTable" cellpadding="0" cellspacing="0">
                <tr class="firstTr">
                	...
                	<#list meetingInfectedList as meetingInfected>
                		<tr>
							<td><span>${meetingInfected.userName?default('')}</span></td>
							<td><span>${meetingInfected.addressName?default('')}</span></td>
							<td><span>${meetingInfected.startTime?default('')}</span></td>
							<td><span>${meetingInfected.createTime?string('yyyy-MM-dd HH:mm')}</span>
						</tr>
                	</#list>
			</table>
