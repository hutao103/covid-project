            ...
            <form id="form" method="post">
                ...
                <div>
                	<label for="userPassword">lnglat</label>
                   	<input type="text" name="lnglat" id="lnglat" value="" maxlength="60">
...
$(function(){
	$("#add").on('click',function(){
		...
		if($(this).attr('data-run') == 0){
			...
			$.ajax({
				type:"GET",
				url:'${request.contextPath}/address/add',
				data:{name:$("#name").val(),lnglat:$("#lnglat").val()},
				dataType:"json",
